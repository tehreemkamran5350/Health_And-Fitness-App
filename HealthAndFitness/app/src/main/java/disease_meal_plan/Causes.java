...
public class Causes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_causes, container, false);
        ...
        textView = (TextView) view.findViewById(R.id.tv_causes);
        textView.setText(diseaseEntity.getCauses());
        return view;
    }
}
